...
#define generate_branch_filler(condition_code, writeback_location)            \
  ...
  ARM_B_COND(0, condition_code, 0xFFFFFF);                                    \
...
{												\
  CLEAR_INSN_CACHE(rom_translation_cache,							\
   (ROM_TRANSLATION_CACHE_SIZE));								\
  CLEAR_INSN_CACHE(ram_translation_cache,							\
   (RAM_TRANSLATION_CACHE_SIZE));								\
  CLEAR_INSN_CACHE(bios_translation_cache,							\
...
void CLEAR_INSN_CACHE(u8 *code, int size)
{
