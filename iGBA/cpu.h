...
#ifdef GP2X_BUILD
void invalidate_cache_region(void* virts, void* virte);
void invalidate_icache_region(void* virts, size_t len);

#define ROM_TRANSLATION_CACHE_SIZE (1024 * 1024 * 2)
#define RAM_TRANSLATION_CACHE_SIZE (1024 * 1024)
#define BIOS_TRANSLATION_CACHE_SIZE (1024 * 512)
